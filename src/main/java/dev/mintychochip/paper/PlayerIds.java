...
final class PlayerIds {
  ...
  /**
   * Resolves a player name to a UUID: online players first, then offline mode name-derived UUIDs,
   * then previously-seen offline players. Messages and returns {@code null} when unresolvable.
   */
