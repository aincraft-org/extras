 ...
 * require a check-then-act (duplicate requests, "already friends") are atomic
 * with respect to concurrent callers. Reads are lock-free.
 */
public final class DefaultFriendService implements FriendService {
    ...
    public FriendResult sendRequest(UUID requesterId, UUID targetId) {
        ...
        synchronized (mutationLock) {
            ...
            boolean pending = repository.findRequest(requesterId, targetId).isPresent()
