 ...
 *
 * <p>A request is directional: {@code requesterId} sent it to
 * {@code targetId}. Only the target may accept or decline it; only the
 * requester may cancel it. Requests do not expire and persist across
...
public final class FriendRequest {
    ...
    public String toString() {
        return "FriendRequest{requesterId=" + requesterId
                + ", targetId=" + targetId
                + ", createdAt=" + createdAt
                + '}';
    }
