 ...
 *
 * <p>Friendships are mutual and require accepting a pending request. Requests are directional and
 * never expire; the recipient accepts or declines, the requester cancels. Friendships persist
 * across restarts via SQLite. All read views are immutable snapshots.
 */
