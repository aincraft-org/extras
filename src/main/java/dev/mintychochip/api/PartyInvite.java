 ...
 *
 * <p>An invite is scoped to exactly one {@code partyId} and one invitee ({@code targetId}). It
 * carries the inviter and the point at which it expires.
 */
